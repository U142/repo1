...
namespace com.ums.UmsCommon
{
    ...
    public enum ADRTYPES
    {
        ...
        RECIPTYPE_PRIVATE_RESIDENT	        = 1 << 23,
        RECIPTYPE_PRIVATE_OWNER_HOME		= 1 << 24,
        RECIPTYPE_PRIVATE_OWNER_VACATION	= 1 << 25,
        SENDTO_USE_ABAS_RECIPIENTS	        = 1 << 26,
    ...
    public class TimeProfiler : IDisposable
    {
        ...
        public TimeProfiler(long Id, String TimerName, ITimeProfilerCollector Collector, ITimeProfilerCallback Callback)
        {
            ...
            TimeProfile = new TimeProfile()
            {
                Id = Id,
                TimerName = TimerName,
                StartedUtc = Int64.Parse(DateTime.UtcNow.ToString("yyyyMMddHHmmss")),
            };
