...
using System.IO;
using System.Text;
using centric.com.ums.ws.pas.status;
...
public class Util
{
    ...
    public static CheckAccessResponse setOccupied(centric.com.ums.ws.pas.admin.ULOGONINFO l, ACCESSPAGE page, Boolean f_lock)
    {
    ...
    public static centric.com.ums.ws.parm.admin.ULOGONINFO convertLogonInfoParmAdmin(centric.com.ums.ws.pas.admin.ULOGONINFO l)
    {
        centric.com.ums.ws.parm.admin.ULOGONINFO logoninfo = new centric.com.ums.ws.parm.admin.ULOGONINFO();
    ...
    public static centric.com.ums.ws.pas.status.ULOGONINFO convertLogonInfoPasStatus(centric.com.ums.ws.pas.admin.ULOGONINFO l)
    {
        centric.com.ums.ws.pas.status.ULOGONINFO logoninfo = new centric.com.ums.ws.pas.status.ULOGONINFO();
        logoninfo.l_deptpk = l.l_deptpk;
        logoninfo.l_userpk = l.l_userpk;
        logoninfo.l_comppk = l.l_comppk;
        logoninfo.sz_password = l.sz_password;
    ...
    public static centric.com.ums.ws.pas.admin.ULOGONINFO convertLogonInfoPasAdmin(centric.com.ums.ws.pas.admin.ULOGONINFO l)
    {
        centric.com.ums.ws.pas.admin.ULOGONINFO logoninfo = new centric.com.ums.ws.pas.admin.ULOGONINFO();
        logoninfo.l_deptpk = l.l_deptpk;
        logoninfo.l_userpk = l.l_userpk;
        logoninfo.l_comppk = l.l_comppk;
        logoninfo.sz_password = l.sz_password;
    ...
    public static centric.com.ums.ws.pas.ULOGONINFO convertLogonInfoPas(centric.com.ums.ws.pas.admin.ULOGONINFO l)
    {
        centric.com.ums.ws.pas.ULOGONINFO logoninfo = new centric.com.ums.ws.pas.ULOGONINFO();
        logoninfo.l_deptpk = l.l_deptpk;
        logoninfo.l_userpk = l.l_userpk;
        logoninfo.l_comppk = l.l_comppk;
        logoninfo.sz_password = l.sz_password;
    ...
    private static void WriteUserActivityMonthly(UPASLOG log, Hashtable users)
    {
        ...
        if (log.l_userpk == -1)
            ...
            if (log.l_userpk != 0)
                AddComma("\"" + ((centric.com.ums.ws.pas.admin.UBBUSER)users[log.l_userpk]).sz_userid + "\"", stringBuilder);
            else
     ...
     *******************************/
    public static void WriteUsersPerAccessPermissionToCSV(List<centric.com.ums.ws.parm.admin.UBBUSER[]> userlist, String[] areaname)
    {
        string attachment = "attachment; filename=AccessPermissions.csv";
        HttpContext.Current.Response.Clear();
        HttpContext.Current.Response.ClearHeaders();
        ...
        {
            foreach (centric.com.ums.ws.parm.admin.UBBUSER user in userlist[i])
                WriteUsersPerAccessPermission(user, areaname[i]);
        }
        HttpContext.Current.Response.End();
    }
    private static void WriteUsersPerAccessPermission(centric.com.ums.ws.parm.admin.UBBUSER user, string areaname)
    {
        StringBuilder stringBuilder = new StringBuilder();
