...
public partial class report_monthly : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ps.Endpoint.Address = new EndpointAddress(ConfigurationManager.AppSettings["PasStatus"]);
    ...
    protected void btn_showClick(object sender, EventArgs e)
    {
        ...
        PasStatusSoapClient pasws = new PasStatusSoapClient();
        pasws.Endpoint.Address = new EndpointAddress(ConfigurationManager.AppSettings["PasStatus"]);
