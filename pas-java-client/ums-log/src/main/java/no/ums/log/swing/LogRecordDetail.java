 ...
 * @author staaleu
 */
public final class LogRecordDetail extends javax.swing.JPanel {
            ...
            exceptionPanelLayout.setVerticalGroup(
                    exceptionPanelLayout.createParallelGroup()
                            .addGroup(exceptionPanelLayout.createSequentialGroup()
                                    ...
                                    .addComponent(jScrollPane3, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
                                    .addContainerGap())
            );
        }
    ...
    public void setLogRecord(@Nullable final LogRecord record) {
