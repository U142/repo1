...
public class AddressFilterInfoVO extends ParmVO implements Cloneable {
	...
	@Override
	public AddressFilterInfoVO clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		AddressFilterInfoVO a = (AddressFilterInfoVO)super.clone();
		if(CBMessages != null) {
	...
	public static final DataFlavor TREE_PATH_FLAVOR = new DataFlavor(AddressFilterInfoVO.class, "Alert");
    ...
    public boolean equals(Object o) {
        ...
        AddressFilterInfoVO FilterVO = (AddressFilterInfoVO) o;

        return !(strAlertpk != null ? !strAlertpk.equals(FilterVO.strAlertpk) : FilterVO.strAlertpk != null);
