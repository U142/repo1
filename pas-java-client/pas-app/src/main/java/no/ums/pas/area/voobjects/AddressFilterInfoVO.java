...
public class AddressFilterInfoVO extends AlertVO implements Cloneable {
    ...
    public AddressFilterInfoVO(String alertpk, String parent, String name,
            int addresstypes, MapPanel map, Navigation nav) {
        super(alertpk, parent, name, addresstypes, map, nav);
    }

    public AddressFilterInfoVO(String alertpk, String parent, String name,
            String description, int profilepk, String schedpk, String oadc,
            int validity, int addresstypes, String timestamp, ShapeStruct shape) {
        super(alertpk, parent, name, description, profilepk, schedpk, oadc,
                validity, addresstypes, timestamp, shape);
    }

    public AddressFilterInfoVO(String alertpk, String parent, String name,
            String description, int profilepk, String schedpk, String oadc,
            int validity, int addresstypes, String timestamp,
            ShapeStruct shape, String[] local_language,
            String[] international_language, Area area, String strCBOadc,
            ArrayList<Object> CBMessages) {
        super(alertpk, parent, name, description, profilepk, schedpk, oadc,
                validity, addresstypes, timestamp, shape, local_language,
                international_language, area, strCBOadc, CBMessages);
    }

    public AddressFilterInfoVO(String strAlertpk, String strParent,
            String strName, int addresstypes) {
    ...
    public String toString() {
        String dateString = this.getCreationTime();
        if (dateString != null) {
    ...
    public void setAddressForFilterlist(
            List<AddressFilterInfo> addressForFilterlist) {
