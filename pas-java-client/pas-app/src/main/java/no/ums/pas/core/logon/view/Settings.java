...
import no.ums.pas.core.logon.IntegerToObject;
import no.ums.pas.core.logon.WmsLayerTree;
import no.ums.pas.localization.Localization;
import no.ums.pas.maps.defines.ShapeStruct;
import no.ums.pas.send.JComboCheckBox;
...
//            System.out.println("inside Settings bEnableAbas="+bEnableAbas);
       ...
       //Add condition
        if("act_set_address_filter".equals(e.getActionCommand()))
        {
          settingsModel1.getAddressFilters().add((AddressFilterInfoVO)e.getSource());
        }
        if("act_remove_address_filter".equals(e.getActionCommand()))
        {
           settingsModel1.getAddressFilters().remove((AddressFilterInfoVO)e.getSource());
        }
    }
    ...
    private void initComponents() {
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                comboAddressFilterList.setCallBackActionListner(this);
    ...
    public boolean isSelected(String filterName){
        ...
        for(int i=0; i< addressFilterList.size(); i++){
            if(filterName.equals(addressFilterList.get(i).getFilterName())){
                settingsModel1.getAddressFilters().add(PAS.get_pas().get_settings().getAddressFilters().get(i));
            return true;
        }
        }
        return false;
           ...
           private void resetAddressFilterList() {
            ...
            log.debug("in settings AddressFilterListCombo size="+comboAddressFilterList.getItemCount());
            comboAddressFilterList.setSelectedItem("");
