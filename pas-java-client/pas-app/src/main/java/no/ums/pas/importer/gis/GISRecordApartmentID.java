...
public class GISRecordApartmentID extends GISRecord {
    ...
    public String get_apartment() { return m_sz_apartment; }
    ...
    public GISRecordApartmentID(String [] sz_info) {
        super();
        set_streetinfo(sz_info);
        m_inhabitants = new ArrayList<InhabitantBasics>(0);
    }

    public GISRecordApartmentID(String m_sz_municipal, String m_sz_streetid, String m_sz_houseno, String m_sz_apartment, String sz_name1, String sz_name2) {
        super();
        this.m_sz_municipal = m_sz_municipal;
        this.m_sz_streetid = m_sz_streetid;
        this.m_sz_houseno = m_sz_houseno;
        this.m_sz_apartment = m_sz_apartment;
        this.m_sz_name1 = sz_name1;
        this.m_sz_name2 = sz_name2;
        m_inhabitants = new ArrayList<InhabitantBasics>(0);
    }
    public GISRecordApartmentID(String sz_municipal, String sz_streetid, String sz_houseno, String sz_letter, String sz_name1, String sz_name2, int lineno) {
    ...
    protected void set_streetinfo(String [] sz_streetinfo) {
        ...
        m_sz_apartment = sz_streetinfo[3];
