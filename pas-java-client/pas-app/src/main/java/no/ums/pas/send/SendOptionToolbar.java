   ...
   public void close() {
    ...
    public void init() {
       ...
       ArrayList<AddressFilterInfoVO> addressFilterList = Variables.getFilterList();
        ...
        /*if(isSettings){
            comboAddressFilterList.setSelectedItem(PAS.get_pas().get_settings().getAddressFilters());
        }*/
        ...
        if (getEventSourceForFilter() != null)
            if (getEventSourceForFilter().equals("predefinedalert")) {
                ...
                if (PAS.get_pas().get_settings().getAddressFilters() != null
                    ...
                    AddressFilterInfoVO vo = Variables.getFilterList().get(0);
                    comboAddressFilterList.setSelectedItem(vo);
                }
            }
}
