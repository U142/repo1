...
public class GISRecordCun extends GISFilterRecord {
    ...
    public GISRecordCun(String[] sz_info) {
        super();
    ...
    public GISRecordCun(String m_sz_municipal, String m_sz_gnr, String m_sz_bnr, String m_sz_fnr, String m_sz_snr, String sz_name1, String sz_name2) {
        super();
    ...
    public GISRecordCun(String m_sz_municipal, String m_sz_gnr, String m_sz_bnr, String m_sz_fnr, String m_sz_snr, String sz_name1, String sz_name2, int lineno) {
