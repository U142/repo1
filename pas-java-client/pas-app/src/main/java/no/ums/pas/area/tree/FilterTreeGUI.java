 ...
 * @author Abhinava
 */
public class FilterTreeGUI extends DefaultPanel implements ComponentListener {
	public static final long serialVersionUID = 1;
    private static final Log log = UmsLog.getLogger(FilterTreeGUI.class);
	...
	public class Tree extends JTree implements DragSourceListener, DropTargetListener, DragGestureListener, ComponentListener, TreeSelectionListener {
		...
		public String getToolTipText(java.awt.event.MouseEvent e)
		{
			...
			if(tip!=null)
			{
				...
				if(tip.getClass().equals(AddressFilterInfoVO.class))
				{
					AddressFilterInfoVO avo = (AddressFilterInfoVO)tip;
                    String tiptext = "<html>" + Localization.l("mainmenu_libraries_predefined_filters") + " = " + avo.getFilterName();
...
//		  }
	...
	public FilterTreeGUI(MainFilterController main) {
		super();
		this.main = main;
