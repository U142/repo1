...
public class GoogleProjection {
    ...
    public GoogleProjection(final int maxZoom, final int size) {
    ...
    public final Point toPoint(final LonLat ll, final int zoom) {
        Point d = zc[zoom];
    ...
    public final LonLat toLonLat(final Point p, final int zoom) {
        Point e = zc[zoom];
    ...
    private static double minmax(final double value, final double min, final double max) {
