...
public final class TileCacheGeodata extends AbstractTileCacheUri {
    ...
    public static enum Layer {
        GeocacheBasis("customservices.geodataonline.no", "/arcgis/rest/services/UMS/UMSBaseMap/MapServer/tile/%d/%d/%d", "token=_rcLdtkkHFdW3CEZL8qr5JiGvbEoFy18uUu8fNZdE9_8_qLbPDlfdyywomkGoqauga_zI4Bk_7Wd-ngtEqxAwQ..");
