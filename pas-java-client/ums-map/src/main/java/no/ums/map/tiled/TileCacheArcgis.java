...
public class TileCacheArcgis extends AbstractTileCacheUri {
    ...
    public static enum Layer {
        ...
        Geocache("services.geodataonline.no", "/arcgis/rest/services/Geocache_WMAS_WGS84/GeocacheBasis/MapServer/tile/%d/%d/%d", "token=_rcLdtkkHFdW3CEZL8qr5JiGvbEoFy18uUu8fNZdE9_8_qLbPDlfdyywomkGoqauga_zI4Bk_7Wd-ngtEqxAwQ..");
