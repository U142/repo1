 ...
 *       &lt;sequence>
 *         &lt;element name="EventUpdateResult" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "EventUpdateResponse")
public class EventUpdateResponse {

    @XmlElement(name = "EventUpdateResult")
    protected boolean eventUpdateResult;
    @XmlElement(required = true)
    protected ULOGONINFO logon;
    protected PAEVENT ev;

    /**
     * Gets the value of the eventUpdateResult property.
     * 
     */
    public boolean isEventUpdateResult() {
        return eventUpdateResult;
    }

    /**
     * Sets the value of the eventUpdateResult property.
     * 
     */
    public void setEventUpdateResult(boolean value) {
        this.eventUpdateResult = value;
    }
