 ...
 *         &lt;element name="municipals" type="{http://ums.no/ws/parm/admin/}ArrayOfUMunicipalDef" minOccurs="0"/>
 *         &lt;element name="typedef1" type="{http://ums.no/ws/parm/admin/}UPolygon" minOccurs="0"/>
 *         &lt;element name="typedef2" type="{http://ums.no/ws/parm/admin/}UEllipse" minOccurs="0"/>
 *         &lt;element name="typedef3" type="{http://ums.no/ws/parm/admin/}UBoundingRect" minOccurs="0"/>
 *         &lt;element name="restrictionShapes" type="{http://ums.no/ws/parm/admin/}ArrayOfUShape" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
