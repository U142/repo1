...
public interface PaswsSoap {
     ...
     * 
     * @return
     *     returns no.ums.ws.pas.PASVERSION
     */
    @WebMethod(action = "http://ums.no/ws/pas/getVersionNumber")
    @WebResult(name = "getVersionNumberResult", targetNamespace = "http://ums.no/ws/pas/")
    @RequestWrapper(localName = "getVersionNumber", targetNamespace = "http://ums.no/ws/pas/", className = "no.ums.ws.pas.GetVersionNumber")
    @ResponseWrapper(localName = "getVersionNumberResponse", targetNamespace = "http://ums.no/ws/pas/", className = "no.ums.ws.pas.GetVersionNumberResponse")
