...
public class SoundRecorder extends Thread {
	...
	public static String VOC_TEMP_PATH_;// = StorageController.StorageElements.get_path(StorageController.PATH_TEMPWAV_);  //"c:\\temp\\java_pas\\";
	  private TargetDataLine  m_line;
	  private AudioFileFormat.Type m_targetType;
	  private AudioInputStream m_audioInputStream;
	  public AudioInputStream get_audioinputstream() { return m_audioInputStream; }
	  ...
	  public ByteArrayOutputStream get_outputstream() { return m_outputstream; }
	  public File get_file() { return m_outputFile; }
	  ...
	  public void stop_recording() { m_f_stoprecording = true; }
	  SoundRecorder m_recorder_thread = null;
	  SoundRecorder get_recorder_thread() { return m_recorder_thread; }
	  ...
	  public boolean isSaving() { return m_recorder_thread.m_b_savetostream; }
	  private boolean _isSaving() { return m_b_savetostream; } //threads own method
	  ...
	  public boolean isFinalized() { return m_b_finalized; }
	  ...
	  public SoundRecorder(/*SendController controller,*/ String sz_path, int RECTYPE, ActionListener osc_callback, AudioFormat format) {//ActionListener osc_callback, float f_samplerate, int n_bits, int n_channels) {	
	      ...
	      if(RECTYPE==RECTYPE_FILE) {
		      try {
		    	  System.out.println(VOC_TEMP_PATH_);
		      	m_outputFile = File.createTempFile("voc", "", new File(VOC_TEMP_PATH_));
