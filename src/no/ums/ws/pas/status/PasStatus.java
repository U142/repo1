 ...
 * 
 */
@WebServiceClient(name = "PasStatus", targetNamespace = "http://ums.no/ws/pas/status", wsdlLocation = "https://secure.ums2.no/centricws/WS/PasStatus.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://secure.ums2.no/centricws/WS/PasStatus.asmx?WSDL");
