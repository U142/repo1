 ...
 */
public class ObjectFolderViewRun {
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                final PaObject paObject = new PaObject();
                paObject.setName("Hello World");
                paObject.setCategorypk(1);
                frame.add(new ObjectFolderLine(paObject, parmService));
                frame.pack();
