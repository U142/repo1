...
public class TasDetailView extends DefaultPanel
{
	...
	StdTextLabel lbl_countrycode	= new StdTextLabel(Localization.l("common_countrycode"), true, 150);
    StdTextLabel txt_countrycode	= new StdTextLabel("", true, 150);
	StdTextLabel lbl_iso			= new StdTextLabel(Localization.l("common_iso3166"), true, 150);
    StdTextLabel txt_iso			= new StdTextLabel("", true, 150);
	StdTextLabel lbl_name			= new StdTextLabel(Localization.l("common_name"), true, 150);
    StdTextLabel txt_name			= new StdTextLabel("", true, 150);
	StdTextLabel lbl_continent		= new StdTextLabel(Localization.l("common_continent"), true, 150);
    StdTextLabel txt_continent		= new StdTextLabel("", true, 150);
	StdTextLabel lbl_isonumeric		= new StdTextLabel(Localization.l("common_iso3166_num"), true, 150);
    StdTextLabel txt_isonumeric		= new StdTextLabel("", true, 150);
	StdTextLabel lbl_touristcount	= new StdTextLabel(Localization.l("main_tas_touristcount"), true, 150);
    StdTextLabel txt_touristcount	= new StdTextLabel("", true, 150);
	StdTextLabel lbl_lastupdate		= new StdTextLabel(Localization.l("main_tas_lastupdate"), true, 150);
	...
	public TasDetailView(ActionListener callback)
	{
        ...
        btn_request_touristcount.setToolTipText(Localization.l("main_tas_panel_request_touristcount"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if("act_show_history".equals(e.getActionCommand()))
		{
			...
			//chart.UpdateChart();
            UMSChartFrame frame = new UMSChartFrame(Localization.l("main_tas_stats_heading_over_time"), true, list);
	...
	@Override
	public void init() {
        btn_sendmessage.setToolTipText(Localization.l("main_tas_send_message"));
	...
	public void setCountry(CommonTASListItem item)
	{
		...
		else if(!ci.isAddedToSendList())
		{
            ...
            btn_add_to_sendlist.setToolTipText(Localization.l("main_tas_add_to_sendlist"));
		}
		else
		{
			btn_add_to_sendlist.setEnabled(true);
			btn_add_to_sendlist.setIcon(ImageLoader.load_icon("subtract_32.png"));
            btn_add_to_sendlist.setToolTipText(Localization.l("main_tas_remove_from_sendlist"));
		}
