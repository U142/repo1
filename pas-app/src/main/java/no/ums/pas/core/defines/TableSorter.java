...
public class TableSorter extends AbstractTableModel {
    ...
    public Object [] getRowContent(int row) {
    	Object [] ret = new Object[getColumnCount()];//new String[m_n_columns];
    ...
    private class Row extends Object implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            for (Iterator it = sortingColumns.iterator(); it.hasNext();) {
                ...
                Object o1 = (Object)tableModel.getValueAt(row1, column);
                Object o2 = (Object)tableModel.getValueAt(row2, column);
